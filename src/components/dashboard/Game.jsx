    ...
    <div>
      <header>
        ...
        <div className="controls">
          <button className="new-game pvp">New PvP</button>
          <button className="new-game ai">New vs AI</button>
          <a
            href="https://github.com/chidiwilliams/ayoayo"
            target="_blank"
            rel="noopener"
          >
      ...
      <div className="no-game-padding"></div>
      <div className="game">
        ...
        <div className="board-wrapper">
          <div className="board">
            <div className="side side-1">
              {/* Repeat this block for each pit-container */}
              <div className="pit-container">
                <button className="pit pit-1">
                  {/* Repeat this block for each seed */}
